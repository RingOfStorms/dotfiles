# initrd SSH recovery for an Oracle Ampere (aarch64) impermanence host.
#
# These boxes run bcachefs + impermanence with a boot-time root reset in
# initrd. If that ever hangs on a headless cloud box, initrd SSH is the only
# way in. Kept as a permanent recovery aid:
#
