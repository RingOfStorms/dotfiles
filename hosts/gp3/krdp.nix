# KRDP — KDE Plasma 6 RDP server.
# Currently duplicated between gp3 and joe; will be promoted to a
# shared module under flakes/common/nix_modules/krdp.nix once both
# hosts are validated end-to-end.
#
